...
fn limit_default_is_20() {
    use monocoque_agent_rem::mcp::resources::slack_channel::DEFAULT_LIMIT;
...
fn resource_template_has_correct_name() {
    use monocoque_agent_rem::mcp::resources::slack_channel::RESOURCE_NAME;
...
fn resource_template_has_description() {
    use monocoque_agent_rem::mcp::resources::slack_channel::RESOURCE_DESCRIPTION;
