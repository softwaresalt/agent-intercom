...
- [ ] T052 [P] Run full quality gate: `cargo clippy --all-targets -- -D warnings -D clippy::pedantic`
- [ ] T053 [P] Run format check: `cargo fmt --all -- --check`
- [ ] T054 Run full test suite and verify 959+ baseline tests still pass plus new tests: `cargo test --all-targets`
- [ ] T055 Update `specs/007-acp-correctness-mobile/spec.md` — update FR-007 description to reflect `channel_id` removal instead of deprecation warning
- [ ] T056 [P] Update `.context/backlog.md` — mark F-06, F-07, F-10, F-13 as complete
