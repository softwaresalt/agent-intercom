...
- Rust stable, edition 2021 + rmcp 0.5 → 0.13.0, axum 0.8, slack-morphism 2.17, sqlx 0.8, tokio 1.37 (003-agent-intercom-release)
- SQLite via sqlx (bundled, file-based prod, in-memory tests) (003-agent-intercom-release)
...
## Recent Changes
- 003-agent-intercom-release: Added Rust stable, edition 2021 + rmcp 0.5 → 0.13.0, axum 0.8, slack-morphism 2.17, sqlx 0.8, tokio 1.37
