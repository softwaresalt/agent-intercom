...
| `1.4.6` | Expected autoharness version string from `autoharness_home` metadata |
...
2. Compare against `1.4.6` (the version of the autoharness installation that would perform upgrades).
