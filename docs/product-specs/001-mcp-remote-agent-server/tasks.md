...
**Input**: Design documents from `docs/product-specs/001-mcp-remote-agent-server/`
...
- [X] T213 [P] [US13] Rename documentation references: update `README.md`, `docs/product-specs/001-mcp-remote-agent-server/quickstart.md`, all `docs/product-specs/**/*.md` files, `.specify/memory/constitution.md`, `.github/copilot-instructions.md`, `agent-rem.code-workspace`
