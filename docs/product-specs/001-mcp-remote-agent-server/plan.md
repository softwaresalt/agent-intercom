...
- [ ] T213 [US13] Rename documentation references: update `README.md`, `quickstart.md`, all `docs/product-specs/**/*.md` files, `.specify/memory/constitution.md`, `.github/copilot-instructions.md`
