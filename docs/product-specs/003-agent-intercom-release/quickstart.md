...
- Familiarity with the existing codebase structure (see `docs/product-specs/001-mcp-remote-agent-server/`)
...
# 5. Verify: search for "monocoque" — zero matches outside docs/product-specs/
```
