...
**Input**: Design documents from `/docs/product-specs/007-acp-correctness-mobile/`
...
- [x] T038 [US4] Document research findings in `docs/product-specs/007-acp-correctness-mobile/research-f15-mobile-modals.md` — conclude with one of: (a) modals work, (b) input broken, (c) modals swallowed
